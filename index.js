...
if (cmd === "help") {
    ...
    ctx.channel.send({
      ...
      embeds: [{
        color: "2F3136",
        title: `${emoji.help} Mysterious Bot Dashboard`,

        description:`**WELCOME TO MY DASHBOARD**${emoji.command}
${emoji.prefix}Prefix : None`,

        image: {
          url: 'https://media.discordapp.net/attachments/1158752755461128262/1206837119352307772/20240213_110913_0000.png?ex=65dd75a7&is=65cb00a7&hm=de18377388e2b42b11b324875cef37ec2cdac75e6b2c0bea574631c482e47a39&' // Replace this URL with your image URL
        },

        fields: [
          {
            name: 'Commands',
            value: 'Joinall,wl add,stock,verify,boost,classic,check,clean,links,botinfo,help,more...',
            inline: true
          }
        ],
        ...
        footer: {
          "text": `${kalash.client} Mysterious Help ${kalash.footer}`,
          "icon_url": `https://media.discordapp.net/attachments/1158752755461128262/1206841191640080395/20240206_163433_0000.png?ex=65dd7972&is=65cb0472&hm=99dbe43e11b6de5704780cf907d43d869080ac2fafe3e037c0e825c648153c5c&`
        }
      }]
    });
}
  ...
  if (cmd === "botinfo") {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        { name: "`🌙`Developer", value: `> **Name :** Masoom`, inline: false },
      )
    ctx.channel.send({
      embeds: [embed]
    })
  ...
  if (cmd === "links") {
    ...
    ctx.channel.send({
      embeds: [{
        title: `${emoji.link} Bot Links`,
        description: `${emoji.links} **Oauth User [Link](${kalash.authLink})** 
  ...
  if (cmd === "stock") {
    ...
    fs.readFile('./object.json', async function(err, data) {
      return ctx.channel.send({
        embeds: [{
          title: `${emoji.user} Stock `,
          description: `${emoji.box}There are  ${JSON.parse(data).length > 1 ? `\`${JSON.parse(data).length}\` members` : `\`${JSON.parse(data).length}\` users in the bot`}\n`,
          color: "2F3136",
          footer: {
            "text": `${kalash.client} By Mysterious ${kalash.footer}`,
            "icon_url": `https://cdn.discordapp.com/attachments/785104663544463390/880023050941255680/774322042970832926.gif`
          }
